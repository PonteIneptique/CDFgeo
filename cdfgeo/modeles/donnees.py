            ...
            "mission": [
                {
                    ...
                    "ville": lieu_mission.ville.ville_intitule,
                    "latlong": (lieu_mission.ville.ville_lat, lieu_mission.ville.ville_long)
                }
...
#
#
# 1. Recuperer toutes les missions
# 2. faire un nouveau dictionnaire où les clefs sont "{}-{}".format(lat, long)
# 3. Dans ce dictionnaire, en valeur, des listes de missions
# 4. Afficher un marqueur par cle de dictionnaire
# 5. Remplir pop-up à partir de la liste de mission
#
#
#
...
class Mission_Lieu(db.Model):
    ...
    def to_json(self):
        ...
        if self.ville:
            data["ville_nom"] = self.ville.ville_intitule
            data["latlong"] = self.ville.ville_lat, self.ville.ville_long
        else:
            data["latlong"] = self.pays.pays_lat, self.ville.pays.pays_long
